...
export default function NavBarre() {
  ...
  return (
    ...
    >
      <ul className="flex items-center justify-around gap-8 px-10 py-5 bg-accent custom-shadow-inner rounded-full backdrop-blur-sm max-[450px]:w-full max-[450px]:rounded-none max-[450px]:gap-4">
